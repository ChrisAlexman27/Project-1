...
//******************************************************************************
// Definition of function intro
// This function demonstrates file prowess by opening a text file called 
// rules and reading from it line by line.
//******************************************************************************
void intro()
{
    ifstream file("rules.txt");
    
    if(!file)                               //if file doesnt open
    {
